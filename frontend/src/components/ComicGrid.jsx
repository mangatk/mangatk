                    ...
                    <div className="pt-2 mt-2 border-t border-white/20">
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {manga.genres.slice(0, 2).map(g => (
                          <span key={typeof g === 'string' ? g : g.name} className="text-[9px] px-1.5 py-0.5 bg-white/10 text-white rounded border border-white/10">
                            {typeof g === 'string' ? g : tDynamic(g.name, g.name_ar)}
                          </span>
                        ))}
                      </div>
                      ...
                      <button className="w-full bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold py-2 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-colors">
                        <FaPlay className="text-xs" /> {t('readNow')}
                      </button>
                    </div>
                  </div>
                </div>
